...
[i] The following plugins will be installed from plugin group 'vmware-tkg/default:v2.5.1'
  NAME                TARGET      VERSION
  isolated-cluster    global      v0.32.1
  management-cluster  kubernetes  v0.32.1
  package             kubernetes  v0.32.1
  ...
  secret              kubernetes  v0.32.1
  telemetry           kubernetes  v0.32.1
[i] Installing plugin 'isolated-cluster:v0.32.1' with target 'global'
[i] Installing plugin 'management-cluster:v0.32.1' with target 'kubernetes'
[i] Installing plugin 'package:v0.32.1' with target 'kubernetes'
[i] Installing plugin 'pinniped-auth:v0.32.1' with target 'global'
[i] Installing plugin 'secret:v0.32.1' with target 'kubernetes'
[i] Installing plugin 'telemetry:v0.32.1' with target 'kubernetes'
[ok] successfully installed all plugins from group 'vmware-tkg/default:v2.5.1'
```
...
Standalone Plugins
  ...
  secret              Tanzu secret management                                            kubernetes  v0.32.1  installed
...
```bash
tanzu cluster list
Downloading the TKG Bill of Materials (BOM) file from 'projects.registry.vmware.com/tkg/tkg-bom:v2.5.1'
Downloading the TKr Bill of Materials (BOM) file from 'projects.registry.vmware.com/tkg/tkr-bom:v1.28.7_vmware.1-tkg.3'
the old providers folder /home/vmadmin/.config/tanzu/tkg/providers is backed up to /home/vmadmin/.config/tanzu/tkg/providers-20240820195714-fmcde9me
 NAME                 NAMESPACE  STATUS   CONTROLPLANE  WORKERS  KUBERNETES        ROLES   PLAN  TKR
  ...
  tkg-preprod-cluster  default    running  3/3           3/3      v1.27.5+vmware.1  <none>  prod  v1.27.5---vmware.1-tkg.3
  tkg-staging-cluster  default    running  1/1           2/2      v1.27.5+vmware.1  <none>  dev   v1.27.5---vmware.1-tkg.3
  tkg-test-cluster     default    running  1/1           2/2      v1.27.5+vmware.1  <none>  dev   v1.27.5---vmware.1-tkg.3
```
...
```bash
tanzu mc upgrade --os-name photon --os-version 5 -v 7
```
...
tanzu cluster list --include-management-cluster -A
 NAME                          NAMESPACE   STATUS   CONTROLPLANE  WORKERS  KUBERNETES        ROLES       PLAN  TKR
  ...
  tkg-staging-cluster           default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  tkg-test-cluster              default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  nprod-tkg-management-cluster  tkg-system  running  3/3           1/1      v1.28.7+vmware.1  management  prod  v1.28.7---vmware.1-tkg.3
```
...
NAME                                          STATUS   ROLES           AGE   VERSION
tkg-dev-cluster-control-plane-jfmmw           Ready    control-plane   42d   v1.27.5+vmware.1
tkg-dev-cluster-md-0-759c8bfc9dx8s8zw-9kz2h   Ready    <none>          41d   v1.27.5+vmware.1
tkg-dev-cluster-md-0-759c8bfc9dx8s8zw-bt5nz   Ready    <none>          41d   v1.27.5+vmware.1
tkg-dev-cluster-md-0-759c8bfc9dx8s8zw-kp6tc   Ready    <none>          42d   v1.27.5+vmware.1
tkg-dev-cluster-md-0-759c8bfc9dx8s8zw-zqtkw   Ready    <none>          39d   v1.27.5+vmware.1
```
...
```bash
 NAME                          NAMESPACE   STATUS   CONTROLPLANE  WORKERS  KUBERNETES        ROLES       PLAN  TKR
  tkg-dev-cluster               default     running  1/1           4/4      v1.27.5+vmware.1  <none>      dev   v1.28.7---vmware.1-tkg.3
  tkg-preprod-cluster           default     running  3/3           3/3      v1.27.5+vmware.1  <none>      prod  v1.27.5---vmware.1-tkg.3
  tkg-staging-cluster           default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  tkg-test-cluster              default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  nprod-tkg-management-cluster  tkg-system  running  3/3           1/1      v1.28.7+vmware.1  management  prod  v1.28.7---vmware.1-tkg.3
...
tanzu kubernetes-release get
  ...
  v1.26.14---vmware.1-tiny.1-tkg.1  v1.26.14+vmware.1-tiny.1-tkg.1  True        True
  v1.26.14---vmware.1-tkg.2         v1.26.14+vmware.1-tkg.2         True        True
  v1.27.11---vmware.1-tiny.1-tkg.1  v1.27.11+vmware.1-tiny.1-tkg.1  True        True
  v1.27.11---vmware.1-tkg.3         v1.27.11+vmware.1-tkg.3         True        True
  v1.28.7---vmware.1-tiny.1-tkg.1   v1.28.7+vmware.1-tiny.1-tkg.1   True        True
  v1.28.7---vmware.1-tkg.3          v1.28.7+vmware.1-tkg.3          True        True
```
...
tanzu cluster available-upgrades get {{ CLUSTER_NAME }}
  ...
  v1.27.11---vmware.1-tiny.1-tkg.1  v1.27.11+vmware.1-tiny.1-tkg.1  True
  v1.27.11---vmware.1-tkg.3         v1.27.11+vmware.1-tkg.3         True
  v1.28.7---vmware.1-tiny.1-tkg.1   v1.28.7+vmware.1-tiny.1-tkg.1   True
  v1.28.7---vmware.1-tkg.3          v1.28.7+vmware.1-tkg.3          True
```

To upgrade workload cluster

```bash
tanzu cluster upgrade {{ CLUSTER_NAME }} --os-name photon --os-version 5 -v 7
```
...
```bash
tanzu cluster list --include-management-cluster -A
  tkg-dev-cluster               default     running  1/1           4/4      v1.28.7+vmware.1  <none>      dev   v1.28.7---vmware.1-tkg.3
  tkg-preprod-cluster           default     running  3/3           3/3      v1.27.5+vmware.1  <none>      prod  v1.27.5---vmware.1-tkg.3
  tkg-staging-cluster           default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  tkg-test-cluster              default     running  1/1           2/2      v1.27.5+vmware.1  <none>      dev   v1.27.5---vmware.1-tkg.3
  nprod-tkg-management-cluster  tkg-system  running  3/3           1/1      v1.28.7+vmware.1  management  prod  v1.28.7---vmware.1-tkg.3
...
Once the upgrade is successful validate all the applications are in running state.
